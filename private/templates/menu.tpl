...
<td bgcolor="#6887bb" valign="top" rowspan=7>
<br>
...
<img width=16 height=16 src='//www.rockbox.org/silk_icons/brick.png' align='top'> <a class="menulink" href="https://gerrit.rockbox.org">patches</a><br>
...
<input type="image" src="https://www.rockbox.org/paypal-donate.gif" border="0" name="submit" alt="">
</form>
